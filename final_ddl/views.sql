...
/*ena index sto Products(Barcode,Name)*/
...
/*Most visited hours per age bracket*/
/*ena index sto Customer(card,date_of_birth) kai ena sto Transaction(card,date_time)*/
...
/*Prefered products per category*/
/*index sto transaction contains product(barcode)*/
...
end as Time_range, sum(Total_amount)
from Transaction
group by Time_range;

/* # of pet shop products bought per pet (PRWRO apo ta duo dika mas queries gia analysh......)*/
...
/*most profitable shop in each city*/
