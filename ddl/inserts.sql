    ...
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-01-02 13:34:21',8 , 114, 'Credit Card', 1);
    ...
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-01-14 15:00:01', 11,117.54 , 'Credit Card', 1);
    ...
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-02-14 15:00:01',6 ,78.6 , 'Cash', 1);
    ...
    /****************************************************************************************************************/
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-03-04 10:00:24',13, 432.79 , 'Credit Card', 2);
    ...
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-04-25 17:00:00',7, 24.76, 'Cash', 2);
    ...
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-04-26 17:00:00', 14, 30.86, 'Cash', 2);
    ...
    /*******************************************************************************************************************/
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-01-01 19:04:23', 1, 500, 'Credit Card', 3);
    insert into TransactionContainsProduct(Date_time, Card, Barcode, Piecies) values('2020-01-01 19:04:23',3,'3330323201',1);

    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-02-01 21:00:00', 1, 100, 'Cash', 3);
    insert into TransactionContainsProduct(Date_time, Card, Barcode, Piecies) values('2020-02-01 21:00:00',3,'6941035879',1);

    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-04-02 20:00:00', 3, 359, 'Cash', 3);
    ...
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-04-04 11:00:21',13, 432.79 , 'Credit Card', 4);
    ...
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-01-25 8:00:00',7, 24.76, 'Credit Card', 4);
    ...
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-01-26 17:00:00', 14, 30.86, 'Cash', 4);
    ...
    /***************************************************************************************************************/
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-03-11 14:22:10', 10, 24.32, 'Cash', 5);
    ...
    /***************************************************************************************************************/
    insert into Transaction(Date_time,Total_piecies, Total_amount, Payment_method, Card) values ('2020-04-21 16:22:40', 14, 263.28 , 'Credit Card', 6);
